...
pygame.init()
screen = pygame.display.set_mode((612, 382))  # flags=pygame.NOFRAME
pygame.display.set_caption("Pygame gericjh Game")
icon = pygame.image.load('images/icon.png.png').convert_alpha()
pygame.display.set_icon(icon)

#player
bg = pygame.image.load('images/bg1 (2).jpg').convert_alpha()
walk_left = [
...
bg_sound = pygame.mixer.Sound('sounds/bg.music.mp3')
bg_sound.play()

ghost_timer = pygame.USEREVENT + 1
pygame.time.set_timer(ghost_timer, 2500)

label = pygame.font.Font('fonts/Roboto-BoldItalic.ttf', 40)
lose_label = label.render('You lose!', False, (8, 8, 8))
restart_label = label.render('Play again', False, (228, 240, 14))
